...
<br />
<div align="center">
  <a href="https://github.com/Antonomy/wedding">
...
<h3 align="center">Wedding Website</h3>
  ...
  <p align="center">
    A wedding website application utilizing the MERN stack, REST Architecture, and MVC Framework. 
    <br />
    <a href="https://github.com/Antonomy/wedding"><strong>Explore the docs »</strong></a>
    <br />
    <a href="https://github.com/Antonomy/wedding">View Demo</a>
    ·
    <a href="https://github.com/Antonomy/wedding/issues">Report Bug</a>
    ·
    <a href="https://github.com/Antonomy/wedding/issues">Request Feature</a>
  </p>
</div>
<details>
...
## About The Project
This application provides all the basic and necessary functionality needed for any wedding website.
- User Sign Up 
- Authentication
- Authorization
- Guestbook 
...
![wedding](./public/images/readme-cover.png)
...
2. Clone the repo
   ```sh
   git clone https://github.com/Antonomy/wedding.git
   ```
...
- [ ] Profile Page User Manipulation
- [ ] Livestream Functionality
- [ ] Contact Us/Email page

See the [open issues](https://github.com/Antonomy/wedding/issues) for a full list of proposed features (and known issues).
