    ...
    <>
      {
                albums && albums.length
                  ...
                  : <h1>No Albums Yet Add One Below</h1>
            }
      {'Name '}<input value={newAlbum.name} onChange={handleChange} name='name' /><br />
      {'Photographer '}<input value={newAlbum.photographer} onChange={handleChange} name='photographer' /><br />
      {'Client '}<input value={newAlbum.client} onChange={handleChange} name='client' /><br />
      {'Released '}<input type='checkbox' checked={newAlbum.released} onChange={(evt) => setNewAlbum({ ...newAlbum, released: evt.target.checked })} /><br />
