...
export default function RegistryPage(props) {
    ...
    return (
        <>
            {
                registries && registries.length ? (<ul>
                    {
                ...
                </ul>) : <h1>No Registries Yet Add One Below</h1>
            }
            {'Name '}<input value={newRegistry.name} onChange={handleChange} name="name"></input><br />
            {'Link '}<input value={newRegistry.link} onChange={handleChange} name="link"></input><br />
